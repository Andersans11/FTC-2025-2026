...
@Configurable
@Autonomous(name = "Simple Blue - Close")
public class Simple_Close_Blue extends RRoboticsOpMode {
    Follower follower;
    ...
    public void onInit() {
        ...
        Pose intakeStartClose = new Pose(48, intakeYClose, Math.toRadians(180));
        Pose intakeEndClose = new Pose(intakeEndPos1, intakeYClose, Math.toRadians(180));
        Pose intakeStartMedium = new Pose(48, intakeYMedium, Math.toRadians(180));
        Pose intakeEndMedium = new Pose(intakeEndPos2, intakeYMedium, Math.toRadians(180));
        Pose intakeStartFar = new Pose(48, intakeYFar, Math.toRadians(180));
        Pose intakeEndFar = new Pose(intakeEndPos2, intakeYFar, Math.toRadians(180));
        Pose gate = new Pose(14, 61, Math.toRadians(140)); // TODO: tune this point
