...
@Autonomous(name="5+0")
public class Auto_50 extends NextFTCOpMode {
    ...
    File routine = new File("TeamCode\\src\\main\\java\\org\\firstinspires\\ftc\\teamcode\\RobotStuff\\PedroJSON\\data\\5+0.json");
    Follower follower;
