...
@Autonomous(name="2+0")
public class Auto_20 extends NextFTCOpMode {
    ...
    File routine = new File("TeamCode\\src\\main\\java\\org\\firstinspires\\ftc\\teamcode\\RobotStuff\\PedroJSON\\data\\2+0.json");
    Follower follower;
