...
public class MaybeSwerveDrive {

    public static double MAX_POWER = 1;

    public DeltaTimer deltatime;

    public MaybeSwervePod[] pods = new MaybeSwervePod[4];

    public double[] rollingtime = new double[10];

    public int writing = 0;

    public MaybeSwerveDrive(RobotConfig robotConfig) {
        pods[0] = new MaybeSwervePod(robotConfig.SwFLDrive.motor, robotConfig.SwFLPivot.servo, robotConfig.SwFLEnc);
        pods[1] = new MaybeSwervePod(robotConfig.SwBLDrive.motor, robotConfig.SwBLPivot.servo, robotConfig.SwBLEnc);
        pods[2] = new MaybeSwervePod(robotConfig.SwFRDrive.motor, robotConfig.SwFRPivot.servo, robotConfig.SwFREnc);
        pods[3] = new MaybeSwervePod(robotConfig.SwBRDrive.motor, robotConfig.SwBRPivot.servo, robotConfig.SwBREnc);
