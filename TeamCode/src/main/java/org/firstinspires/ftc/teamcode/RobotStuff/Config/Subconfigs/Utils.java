...
public class Utils {
    public static final String PRIORITY = "aaa";
    public static final String UTILITY = "aba";
    public static final String WORKING = "abb";
    public static final String TUNE = "abc";
